...
#pragma region serializeComponents
    ...
    void serializeSinusoidalMotorConstraint(const MotorConstraintTemplate<SineWaveController> &constraint,
                                            std::ostream &ostream)
    {
        serializeBasicTypes<double>(constraint.minValue, ostream);
        serializeBasicTypes<double>(constraint.maxValue, ostream);
    ...
    MotorConstraintTemplate<SineWaveController> *deserializeSinusoidalMotorConstraint(std::istream &istream)
    {
        ...
        MotorConstraintTemplate<SineWaveController> *newConstraint = new MotorConstraintTemplate<SineWaveController>(
            minLength, maxLength, period);
        newConstraint->currentStepInPeriod = currentStepInPeriod;
...
#pragma region serializePartPhysicalAndRelated
    ...
    Part *DeSerializationSessionPrototype::deserializePartData(const GlobalCFrame &cframe, WorldLayer *layer,
                                                               std::istream &istream)
    {
    ...
    RigidBody DeSerializationSessionPrototype::deserializeRigidBodyWithContext(
        const GlobalCFrame &cframeOfMain, std::vector<ColissionLayer> &layers, std::istream &istream)
    {
    ...
    void SerializationSessionPrototype::serializeConstraintInContext(const PhysicalConstraint &constraint,
                                                                     std::ostream &ostream)
    {
    ...
    void SerializationSessionPrototype::serializeMotorizedPhysicalInContext(
        const MotorizedPhysical &phys, std::ostream &ostream)
    {
    ...
    void DeSerializationSessionPrototype::deserializeConnectionsOfPhysicalWithContext(
        std::vector<ColissionLayer> &layers, Physical &physToPopulate, std::istream &istream)
    {
        ...
        for (uint32_t i = 0; i < childrenCount; i++)
        {
            ...
            GlobalCFrame cframeOfConnectedPhys = physToPopulate.getCFrame().localToGlobal(
                connection.getRelativeCFrameToParent());
    ...
    MotorizedPhysical *DeSerializationSessionPrototype::deserializeMotorizedPhysicalWithContext(
        std::vector<ColissionLayer> &layers, std::istream &istream)
    {
...
#pragma endregion
    ...
    void SerializationSessionPrototype::serializeParts(const Part *const parts[], size_t partCount,
                                                       std::ostream &ostream)
    {
    ...
    void SerializationSessionPrototype::serializeCollectedHeaderInformation(std::ostream &ostream)
    {
        ...
        this->shapeSerializer.sharedShapeClassSerializer.serializeRegistry(
            [](const ShapeClass *sc, std::ostream &ostream) { dynamicShapeClassSerializer.serialize(*sc, ostream); },
            ostream);
    }
    ...
    void DeSerializationSessionPrototype::deserializeAndCollectHeaderInformation(std::istream &istream)
    {
        ...
        shapeDeserializer.sharedShapeClassDeserializer.deserializeRegistry([](std::istream &istream)
        {
            return dynamicShapeClassSerializer.
                    deserialize(istream);
        }, istream);
    }

    static const ShapeClass *builtinKnownShapeClasses[]{
        &CubeClass::instance, &SphereClass::instance, &CylinderClass::instance
    };

    SerializationSessionPrototype::SerializationSessionPrototype(
        const std::vector<const ShapeClass *> &knownShapeClasses) : shapeSerializer(builtinKnownShapeClasses)
    {
    ...
    DeSerializationSessionPrototype::DeSerializationSessionPrototype(
        const std::vector<const ShapeClass *> &knownShapeClasses) : shapeDeserializer(builtinKnownShapeClasses)
    {
        for (const ShapeClass *sc: knownShapeClasses)
        {
...
#pragma region dynamic serializers
    ...
    static DynamicSerializerRegistry<HardConstraint>::ConcreteDynamicSerializer<FixedConstraint>
    fixedConstraintSerializer
            (serializeFixedConstraint, deserializeFixedConstraint, 0);
    static DynamicSerializerRegistry<HardConstraint>::ConcreteDynamicSerializer<ConstantSpeedMotorConstraint>
    motorConstraintSerializer
            (serializeMotorConstraint, deserializeMotorConstraint, 1);
    static DynamicSerializerRegistry<HardConstraint>::ConcreteDynamicSerializer<SinusoidalPistonConstraint>
    pistonConstraintSerializer
            (serializePistonConstraint, deserializePistonConstraint, 2);
    static DynamicSerializerRegistry<HardConstraint>::ConcreteDynamicSerializer<MotorConstraintTemplate<
        SineWaveController>> sinusiodalMotorConstraintSerializer
