...
namespace P3D
{
    ...
    struct AddableBuffer : public BufferWithCapacity<T>
    {
        ...
        AddableBuffer(T *data, size_t dataSize, size_t initialCapacity) : BufferWithCapacity<T>(initialCapacity),
                                                                          size(dataSize)
        {
            assert(data != nullptr);
    ...
    public:
        ...
        CircularBuffer(const CircularBuffer<T> &other) : buf(new T[other.capacity + 1]), curI(other.curI),
                                                         capacity(other.capacity), hasComeAround(other.hasComeAround)
        {
        ...
        CircularBuffer(CircularBuffer<T> &&other) : buf(other.buf), curI(other.curI), capacity(other.capacity),
                                                    hasComeAround(other.hasComeAround)
        {
            other.buf = nullptr;
            other.capacity = 0;
            other.curI = 0;
