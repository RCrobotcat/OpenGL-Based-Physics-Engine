...
namespace P3D
{
    ...
    struct PartIntersection
    {
        ...
        PartIntersection(const Position &intersection, const Vec3 &exitVector) : intersects(true),
    ...
    public:
        ...
        Part(const Shape &shape, Part &attachTo, HardConstraint *constraint, const CFrame &attachToParent,
             const CFrame &attachToThis, const PartProperties &properties);
