...
namespace P3D
{
    ...
    protected:
        ...
        // deletes the given physical
        void attachPhysical(Physical *phys, HardConstraint *constraint, const CFrame &attachToThis,
                            const CFrame &attachToThat);

        // deletes the given physical
        void attachPhysical(MotorizedPhysical *phys, HardConstraint *constraint, const CFrame &attachToThis,
                            const CFrame &attachToThat);
    ...
    public:
        ...
        ConnectedPhysical(Physical &&phys, Physical *parent, HardConstraint *constraintWithParent,
                          const CFrame &attachOnThis, const CFrame &attachOnParent);
    ...
    public:
        ...
        */
        ...
        InternalMotionTree getInternalRelativeMotionTree(
        ...
        double getInertiaOfPointInDirectionRelative(const Vec3Relative &relativePoint,
                                                    const Vec3Relative &relativeDirection) const;
    ...
    public:
        inline InternalMotionTree(const MotorizedPhysical *motorPhys,
                                  MonotonicTree<RelativeMotion> &&relativeMotionTree) : motorPhys(motorPhys),
    ...
    private:
        inline COMMotionTree(const MotorizedPhysical *motorPhys, MonotonicTree<RelativeMotion> &&relativeMotionTree,
                             double totalMass, Vec3 centerOfMass,
                             TranslationalMotion motionOfCenterOfMass) : motorPhys(motorPhys),
                                                                         relativeMotionTree(
                                                                             std::move(relativeMotionTree)),
                                                                         totalMass(totalMass),
                                                                         centerOfMass(centerOfMass),
                                                                         motionOfCenterOfMass(motionOfCenterOfMass),
                                                                         mainCOMOffset(
                                                                             motorPhys->rigidBody.localCenterOfMass -
                                                                             centerOfMass)
        {
        }
